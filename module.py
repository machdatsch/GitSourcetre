...
class Seminar(Module):
    ...
    def __str__(self):
        ######## CODE MISSING HERE
        return "Seminar in Software Engeneering under the topic: " + self.get_topic()
...
class Thesis(Module):
    ...
    def __str__(self):
        ######## CODE MISSING HERE
        return "Bachelor Thesis on the topic: %s in the Research Group %s" % (self.__topic, self.__research_group)
